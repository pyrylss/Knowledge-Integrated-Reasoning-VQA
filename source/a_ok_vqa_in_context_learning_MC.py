...
def val_in_context_learning_a_ok_vqa_with_beit_MC(llama_model, 
  ...
  with open("/Knowledge-Integrated-Reasoning-VQA/knowledge_guided_captions/aokvqa_train_captions_w_knowledge.json", 'r') as f:
        train_captions_w_knowledge = json.load(f)
  with open("/Knowledge-Integrated-Reasoning-VQA/knowledge_guided_captions/aokvqa_val_captions_w_knowledge.json", 'r') as f:
...
def test_in_context_learning_a_ok_vqa_with_beit_MC(llama_model,
  ...
  with open("/Knowledge-Integrated-Reasoning-VQA/knowledge_guided_captions/aokvqa_test_captions_w_knowledge.json", 'r') as f:
