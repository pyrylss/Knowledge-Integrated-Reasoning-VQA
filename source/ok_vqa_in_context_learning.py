...
def val_in_context_learning_ok_vqa_with_beit(llama_model, 
  ...
  with open("/Knowledge-Integrated-Reasoning-VQA/knowledge_guided_captions/okvqa_train_captions_w_knowledge.json", 'r') as f:
        train_captions_w_knowledge = json.load(f)
  with open("/Knowledge-Integrated-Reasoning-VQA/knowledge_guided_captions/okvqa_val_captions_w_knowledge.json", 'r') as f:
