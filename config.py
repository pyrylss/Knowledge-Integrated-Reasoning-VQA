...
def get_config(sysv):
    ...
    parser.add_argument('--dataset', type=str, choices = ['ok_vqa', 'a_ok_vqa', 'get_info'], default='ok_vqa', help='dataset to use')
    ...
    parser.add_argument('--promptcap_captions_dir_train', type=str, default=None, help='The path to the train question prompcap captions')
